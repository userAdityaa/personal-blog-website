function NavBar(){
    return(
        <nav className="flex items-center bg-[#222222] h-[5rem] w-[100vw] justify-between">
            ...
            <div className="h-[100%] w-[19.5%] bg-[#222222]  flex  items-center border border-white shadow-inner-new shadow-white">
                <img src='svg-image-1.svg' className="h-[35%] ml-[3rem]"></img>
            </div>
            
            <div className="w-[66%] flex justify-center h-[100%] bg-[#222222] border border-white shadow-inner-new shadow-white">
            ...
            <div className="text-white w-[15%] flex justify-center h-[100%] items-center text-[13.96px] bg-[#222222] border border-white shadow-inner-new shadow-white">
